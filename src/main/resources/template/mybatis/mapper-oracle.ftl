...
<mapper namespace="${modelClassSimpleName?uncap_first}Dao">
  <resultMap id="${modelClassSimpleName?uncap_first}" type="${project.basePackageName}.${project.projectName}.datamodel.${modelClassSimpleName}">
  ...
  <sql id="sql_force_update_set">
    ...
    <#list propertyNameList as propertyName>
      ...
      <#if propertyName == "updatedAt">
      <if test="!_parameter.containsKey('entity_${propertyName}')">,${columnInfoList[propertyName_index].columnName} = SYSDATE</if>
      </#if>
    </#list>
    </trim>
  </sql>
  ...
  <insert id="insert" parameterType="java.util.Map">
    <selectKey keyProperty="entity.id" resultType="java.lang.Long" order="BEFORE">
