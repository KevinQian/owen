...
<mapper namespace="${modelClassSimpleName?uncap_first}DAO">
  ...
  <sql id="sql_force_update_set">
    <trim prefix="SET" prefixOverrides=",">
    <#list propertyNameList as propertyName>
      <if test="_parameter.containsKey('entity_${propertyName}')">,${columnInfoList[propertyName_index].columnName} = ${r"#"}{entity_${propertyName}, jdbcType=${columnInfoList[propertyName_index].columnTypeName}}</if>
      <#if propertyName == "updatedAt">
